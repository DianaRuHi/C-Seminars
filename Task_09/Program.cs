...
int dig1 = randNum % 10;
int dig2 = randNum / 10;
int digMax = dig1 > dig2 ? dig1 : dig2;
...
if (dig1 == dig2) Console.WriteLine($"Цифры числа {randNum} одинаковы");
else Console.WriteLine($"Наибольшая цифра числа {randNum} => {digMax}");